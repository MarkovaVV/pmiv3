...
screen quick_menu():
    ...
    if quick_menu:
        ...
        hbox:
            ...
            textbutton _("Опции") action [Play("select", "sounds/pausemenu.mp3"), ShowMenu('preferences')]
...
init python:
    renpy.music.register_channel("select", "sfx", False)
    renpy.music.register_channel("hover", "sfx", False)
...
screen main_menu():
    ...
    imagemap:
        ...
        hotspot(740, 62, 442, 90) action [Play("select", "sounds/menuselect.mp3"), Start()] hovered Play("hover", "sounds/menuhover.mp3") # кнопка старта
        hotspot(814, 175, 296, 56) action [Play("select", "sounds/menuselect.mp3"), ShowMenu("preferences")] hovered Play("hover", "sounds/menuhover.mp3") # кнопка настроек
        hotspot(854, 261, 214, 44) action [Play("select", "sounds/menuselect.mp3"), ShowMenu("about")] hovered Play("hover", "sounds/menuhover.mp3") # кнопка об игре
        hotspot(851, 335, 222, 44) action [Play("select", "sounds/menuselect.mp3"), ShowMenu("help")] hovered Play("hover", "sounds/menuhover.mp3") # кнопка помощь
        hotspot(50, 37, 177, 56) action [Play("select", "sounds/menuselect.mp3"), Quit(confirm=True)] hovered Play("hover", "sounds/menuhover.mp3") # кнопка выйти
